...
**Who would care about it and why:**
Anyone making a small real-world decision that touches currency — someone comparing prices across countries, planning to send or receive money internationally, or just curious whether a currency they're watching is strengthening or weakening — gets an instant, readable answer instead of a spreadsheet.

**One thing I'd build next with another week:**
A small watchlist feature — let a user save 2-3 currency pairs and get a daily one-line summary of how each has moved, instead of having to re-enter the pair each time.
